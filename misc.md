...
<div class="misc-container">
    ...
    <div class="misc-section">
        ...
        <div class="misc-text">
            ...
            <p>
                I recently visited one of the largest recommerce warehouses in San Francisco and was amazed to see the intricate processes behind recycling pre-owned items. Click <a href="/recommerce_visits.md/">here</a> to see more photos behind the scene!
            </p>
        </div>
    </div>
    <!-- Section 3 -->
