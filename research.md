...
<br><span style="font-size: 16px;">Conference Presentations: <em>WISE 2024, Marketing Science 2025, Platform Strategy Research Symposium 2025, CIST 2025, INFORMS 2025, IIOC 2026 (upcoming) </em></span>
...
<br><span style="font-size: 16px;"><em>Accepted, Information Systems Research</em></span>
...
<div style="background-color: #f9f9f9; border-left: 4px solid #007BFF; padding: 12px 16px; font-size: 0.9em; line-height: 1.5em; border-radius: 4px;">
  <div style="font-weight: bold; margin-bottom: 6px;">I am very fortunate to have my research supported by</div>
